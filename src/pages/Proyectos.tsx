...
const Proyectos = () => {
  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Background starfield (always visible on this page) */}
      ...
      {/* CLOSING */}
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-32 md:py-48 text-center">
        <h2
        ...
        <div className="mt-20 max-w-xl mx-auto flex items-center gap-3">
          <div className="h-px flex-1 bg-foreground/10">
            <div
              ...
              style={{
                width: "60%",
                background:
                  "linear-gradient(90deg, transparent, hsl(var(--primary) / 0.7))",
              }}
            />
          </div>
          <span
            ...
            style={{
              ...
              boxShadow: "0 0 10px hsl(var(--secondary) / 0.7)",
